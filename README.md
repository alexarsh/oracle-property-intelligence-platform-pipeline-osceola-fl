# Oracle Property Intelligence Platform Pipeline - Osceola County, FL
...
The Oracle ingestion pipeline has been started, but the full **Osceola County, FL** dataset has not been completely uploaded, reconciled, or demonstrated. The infrastructure must be designed so Oracle does not carry ongoing infrastructure cost by default. For this candidate exercise, the candidate acts as both Oracle and builder: they are responsible for completing the pipeline and proving the low-cost infrastructure approach.
...
### Geography & coverage
- Target **Osceola County, FL** as the default and primary county for ingestion and demos.
...
- Presenter: “Now I am asking the same type of questions through the agent.”
  - Agent Prompt: “Which properties in Osceola County within five miles of [city xyz] have roofs older than 15 years?”
