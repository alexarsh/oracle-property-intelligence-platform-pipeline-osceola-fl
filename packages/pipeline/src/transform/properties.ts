  ...
  await db.run(`
    ...
    WITH agg AS (
      SELECT parcel_identifier,
             ...
             max(CASE WHEN is_roofing THEN coalesce(permit_close_date, permit_issue_date, opened_date) END) AS last_roof_permit_date,
    ...
    SELECT
      ...
      h.effective_year, h.last_roof_permit_date, h.roof_age_basis, h.roof_age_years, h.open_roof_permit_count,
