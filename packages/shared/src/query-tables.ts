...
export const PLACES_COLUMNS: readonly ColumnSpec[] = [
  { name: "place_id", type: "VARCHAR", kit: false, description: "Overture GERS id (stable across releases)." },
  { name: "name", type: "VARCHAR", kit: false, description: "Primary business / place name." },
  { name: "taxonomy_primary", type: "VARCHAR", kit: false, description: "Most specific Overture taxonomy label." },
  { name: "taxonomy_hierarchy", type: "VARCHAR", kit: false, description: "'/'-joined L0..primary taxonomy path (canonical roll-up field)." },
  { name: "basic_category", type: "VARCHAR", kit: false, description: "Coarse Overture category." },
  { name: "is_contractor", type: "BOOLEAN", kit: false, description: "Taxonomy path names a construction / roofing / home-improvement contractor." },
  { name: "operating_status", type: "VARCHAR", kit: false, description: "open / closed / … as published by Overture." },
  { name: "confidence", type: "DOUBLE", kit: false, description: "Overture existence confidence (0..1)." },
  { name: "phone", type: "VARCHAR", kit: false, description: "Normalized 10-digit phone (first listed)." },
  ...
  { name: "contractor_id", type: "VARCHAR", kit: false, description: "Permit-derived contractor entity matched by phone, when any." },
  { name: "source_datasets", type: "VARCHAR", kit: false, description: "'|'-joined Overture source datasets (attribution)." },
  { name: "overture_release", type: "VARCHAR", kit: false, description: "Pinned Overture release the row came from." },
  { name: "source_url", type: "VARCHAR", kit: false, description: "Overture STAC catalog URL for the release." },
